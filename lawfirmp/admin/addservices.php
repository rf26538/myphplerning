	        ...
	        <div class="col-md-12">
                      <div class="card">
                        ...
                        <div class="card-content">
                           <form class="col s12" method="POST" name="addMenu" action="insertservices.php">
                              <div class="row">
                                 <div class="input-field col s6">
                                    <input  id="menu_name" name="menu_name" type="text" class="validate" require>
                                    <label for="first_name">Services Name</label>
                                 </div>
                                 <div class="input-field col s6">
                                    <input id="last_name" type="text" name="menu_link" class="validate" require>
                                    <label for="last_name">Services Link</label>
                                 </div>
                                 <div class="input-field col s6">
                                    <input id="icon_class" type="text" name="icon_class" class="validate" require>
