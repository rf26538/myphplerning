	        ...
	        <div class="col-md-12">
                      <div class="card">
                        ...
                        <div class="card-content">
                           <form class="col s12" method="POST" name="addMenu" action="updatebanners.php" enctype="multipart/form-data">
                              <div class="row">
                                 ...
                                 <div class="input-field col s6">
                                    <input  id="menu_name" name="heading" type="text" class="validate valid" required value="<?= $result[0]['heading']?>">
                                    <label for="first_name" class="active">Heading</label>
